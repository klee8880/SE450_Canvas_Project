...
public class Shape {
	...
	protected Shape(Point begin, int height, int width) {
	...
	protected Shape(ShapeType type, ShapeShadingType shading, Color primary, Color secondary, Point begin, int height, int width) {
